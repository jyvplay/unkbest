 ...
 * Version: v1.1.0-RESTORE-SIDECAR-AUTHORITATIVE
 */
import fs from 'fs';
...
console.log("🚀 Starting Programmatic Sidecar Reversion Sentinel v1.1.0...");
...
// 7. Re-create tsconfig.json paths (with strict JSON comment scrubber)
console.log("📄 Re-creating tsconfig.json paths...");
if (fs.existsSync('tsconfig.json')) {
    const rawContent = fs.readFileSync('tsconfig.json', 'utf-8');
    // Strip multi-line (/* ... */) and single-line (// ...) comments cleanly
